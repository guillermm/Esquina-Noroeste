...
function solcosto(costo_i,costo_total,vbasc,costos_f)
%
%   Entrada: 
%           costo_i: muestra el costo de todas las interaciones
%           costo_total: ultima solución costo total
%           vbasc: variables básicas
%           costos_f: asignaciones de las variables básicas 
%
